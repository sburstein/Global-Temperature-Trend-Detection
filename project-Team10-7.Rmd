...
natural disasters. [NASA.gov Source](https://climate.nasa.gov/effects/). [USGS.gov Source](https://www.usgs.gov/faqs/how-can-climate-change-affect-natural-disasters-1?qt-news_science_products=0#qt-news_science_products)
...
Our third hypothesis test found that there is not sufficient evidence of an 
increase in global, annual temperature change in more recent decades compared to
the earlier 20th century. However, temperature is still increasing. This result 
is likely due to limitations in our data, as it is widely established in the 
scientific community that the rate of annual temperature change has increased in 
recent decades per NOAA: 
