...
customColorGrad <- RColorBrewer::brewer.pal(100, 'YlOrRd')
...
associated scatter plots, there is meaningful evidence that the rate of change 
of temperature has increased, especially since 1975. 
