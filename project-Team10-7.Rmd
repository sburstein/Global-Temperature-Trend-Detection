...
increase in average degree of temperature change after 2000. While there 
the dataset had limited values after 2000, it still shows evidence that
...
differ from the mean change in temperature globally but that the USA is more 
