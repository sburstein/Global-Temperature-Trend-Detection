...
We can be 99% confident that the difference in means of average year-to-year net fluctuation after 1980 and before 1980 lies within these bounds. 
...
t.test(differences ~ post1980,
  ...
  conf.level = 0.99)
```
The p-values from both the simulation-based and CLT-based hypothesis tests performed here are both greater than $\alpha = 0.05$, so we fail to reject the null hypothesis.
In this case, the p-value represents the likelihood of obtaining results where the net fluctuation from year to year in 1980 has a difference with respect to the net fluctuations before 1980 as great as observed or greater.
In context of our question, this means we may not have sufficient evidence of an increase in overall temperature changes from year to year in more recent decades compared to earlier in the 20th century.
