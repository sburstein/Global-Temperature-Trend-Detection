...
use a higher $\alpha$ level of 0.05.
...
```{r visualization-by-season, warning = FALSE, echo = FALSE, fig.height=3.5, fig.align="center"}
...
```{r temp-oceans, echo = FALSE, fig.height=3.5, fig.align="center"}
ggplot(data=df, aes(x=dt, y=LandAndOceanAverageTemperature)) +
  geom_point(aes(color=season), size=0.8) + 
  labs(title = "Global average land + ocean \ntemperatures since 1900",
       x = "Year",
...
```{r annual-avg-viz, message = FALSE, echo = FALSE, fig.height=3.5, fig.align="center"}
annual_avg <- df %>%
  group_by(year) %>%
...
```{r facet-season, echo = FALSE, fig.height=3.5, fig.align="center"}
ggplot(data=df, aes(x=dt, y=LandAverageTemperature)) +
...
```{r highs-lows-visualization, echo = FALSE, fig.height=3.5, fig.align="center"}
...
```{r visualization-by-country, echo = FALSE, fig.height=3.5, fig.align="center"}
legend_mod <- function() {
  theme(legend.position="right",
...
```{r per-year-diffs-viz, echo = FALSE, fig.height=3.5, fig.align="center"}
...
```{r visualization-anomalies, echo = FALSE, fig.height=3.5, fig.align="center"}
...
``` {r every-five-yrs-viz, echo = FALSE, fig.height=3.5, fig.align="center"}
...
```{r 2000-lm-viz, message = FALSE, echo = FALSE, fig.height=3.5, fig.align="center"}
annual_avg <- annual_avg %>%
...
``` {r 2000-bootstrap-test, echo = FALSE, fig.height=3.5, fig.align="center"}
...
```{r net-change, echo = FALSE, fig.height=3.5, fig.align="center"}
...
```{r df-rworldmap, message = FALSE, warning = FALSE, echo = FALSE}
...
```{r viz-rworldmap, message = FALSE, warning = FALSE, echo = FALSE, fig.align="center"}
