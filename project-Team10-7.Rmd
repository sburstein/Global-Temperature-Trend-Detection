...
$H_o$: The mean difference between annual average temperatures after 1980 and 
the overall average temperature in the 20th century is not significantly greater than the 
difference for years before 1980.  

$H_a$: The mean difference between annual average temperatures after 1980 and 
the overall average temperature in the 20th century is greater than the 
difference for years before 1980.  
...
Null hypothesis:  
The mean anomaly of annual temperature averages with respect to the 20th century average
is not greater than 

difference between mean earth surface temperature in recent years 
...
The difference between mean earth surface temperature in recent years 
(1980-2013) and the mean earth surface temperature throughout the 20th century 
...
ggplot(data=comparison_to_20th, aes(x=year, y=comp)) +
  ...
  labs(title=
  "Anomalies of average temperatures \n with respect to 20th century average",
    x = "Year",
    y = "Difference from 20th century average",
    fill = "Differences") + 
  theme_economist_mod() + 
  scale_fill_gradientn(colours = gradientcolors) +
  legend_mod()
...
```{r compare-to-20th-bootstrap, echo = FALSE}
...
```
Our 99% confidence interval for this hypothesis test is (0.4711, 0.790).
...
ggplot(data = shifted, aes(x = shifted)) +
  geom_histogram(color = "#4C566A", fill = "#88C0D0",bins=40) +
  geom_vline(xintercept = obs_diff, color = "#BF616A", lwd=1) +
  annotate("text", 
           x = obs_diff - 0.04, y = 300, 
...
annual temperature and the average 20th century temperature, under the assumption
that the mean earth surface temperatures after 1980 do not differ from the means of pre-1980
years by a statistically significant amount. From both tests, 
